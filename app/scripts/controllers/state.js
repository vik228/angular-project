...
zopkyFrontendApp.controller('stateController', function($scope) {
...
$scope.editActivity = function(id) {
  if (id == 'new') {
    ...
    $scope.activityName = $scope.states[id-1].activityName;
    $scope.city = $scope.states[id-1].city; 
    $scope.country = $scope.states[id-1].country; 
    $scope.type = $scope.states[id-1].type; 
    $scope.continent = $scope.states[id-1].continent;
    $scope.state = $scope.states[id-1].state; 
    $scope.lat = $scope.states[id-1].lat; 
    $scope.long  = $scope.states[id-1].long; 
    $scope.openTime  = $scope.states[id-1].openTime; 
  }
};
