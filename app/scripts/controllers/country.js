...
zopkyFrontendApp.controller('countryController', function($scope) {
...
$scope.editActivity = function(id) {
  if (id == 'new') {
    ...
    $scope.activityName = $scope.countries[id-1].activityName;
    $scope.city = $scope.countries[id-1].city; 
    $scope.country = $scope.countries[id-1].country; 
    $scope.type = $scope.countries[id-1].type; 
    $scope.continent = $scope.countries[id-1].continent;
    $scope.state = $scope.countries[id-1].state; 
    $scope.lat = $scope.countries[id-1].lat; 
    $scope.long  = $scope.countries[id-1].long; 
    $scope.openTime  = $scope.countries[id-1].openTime; 
  }
};
